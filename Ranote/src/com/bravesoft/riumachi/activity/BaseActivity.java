...
public class BaseActivity extends Activity implements DialogCancelListener {

	protected CustomProgressDialog mProgressDialog; //londing dialog
	public App mApp = App.getInstance(); //App instance
	private AppManager mAppManager; //App manager
	...
	/**
	 * 
	 * @param id The view's id ,be defined in xml file.
	 * @param isMin 
	 * @param textSize The text's width(pixel) size in screen is 720*1080.
	 * @param typeFace The constant been defined in 'TextTypeFace'.
	 * @return A Textview
	 */
	protected <T extends View> T getTextView(int id, boolean isMin,
