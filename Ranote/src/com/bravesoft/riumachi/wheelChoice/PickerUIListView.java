...
class PickerUIListView extends ListView  {
    ...
    private void createEditModeView(Context context) {
        ...
        setSelection(2);// set  current black item  
    }
            ...
            public void onGlobalLayout() {
                ...
                if (PickerUIListView.this.items != null) {
                   // selectListItem(PickerUIListView.this.items.size() / 2, false);
                	System.out.println("139--"+mShowItemposition);
                	selectListItem(mShowItemposition, false);//  set current show item 
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    mItemClickListenerPickerUI
                            .onItemClickItemPickerUI(which, position, items.get(position % items.size()));
    ...
    public   void setShowItemposition(int position ){
		   mShowItemposition = position;
		   if(mPickerUIAdapter !=null)
		   mPickerUIAdapter.updata(mShowItemposition);
		   
		   selectListItem(mShowItemposition, false);
	 }
